...
public class AddDeviceSelectionEffect : MonoBehaviour
{
    ...
    public void AddSelection(int? Reihen = null)
    {
        foreach(SpawnedObject spawned in ObjectSpawnerOwn.objekte){
            switch(spawned.objectType){
                case TypVonObject.LAMP:
                    ...
                    lightObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, LightPrefab);});
                    break;
                case TypVonObject.LIGHTSWITCH:
                    ...
                    // lightswitchObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, LightSwitchPrefab);});
                    break;
                case TypVonObject.BLINDSWITCH:
                    ...
                    // blindswitchObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, BlindSwitchPrefab);}); 
                    break;
                case TypVonObject.MOTIONSENSOR:
                    ...
                    // motionsensorObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, MotionsensorPrefab);});
                    break;
                case TypVonObject.BLIND:
                    ...
                    blindObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, BlindPrefab);});
                    break;
                case TypVonObject.SPEAKER:
                    ...
                    speakerObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, SpeakerPrefab);});
                    break;
                case TypVonObject.AIRCONDITIONER:
                    ...
                    conditionerObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, AirConditionerPrefab);});
                    break;
                case TypVonObject.AIRPURIFIER:
                    ...
                    purifierObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, AirPurifierPrefab);});
                    break;
                case TypVonObject.AIRSENSOR:
                    ...
                    airsensorObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, AirSensorPrefab);});
                    break;
                case TypVonObject.CONTROLSYSTEM:
                    ...
                    // controlsystemObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, ControlSystemPrefab);});
                    break;
                case TypVonObject.TV:
                    ...
                    tvObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, TVPrefab);});
                    break;
                case TypVonObject.COFFEE:
                    ...
                    coffeeObject.GetComponentInChildren<Button>().onClick.AddListener(delegate {OnButtonClick(spawned.objectType, spawned.name, CoffeePrefab);});
                    break;
            }
        }
    ...
    private UnityAction OnButtonClick(TypVonObject objectType, string name, GameObject gameObject, bool cancel = false)
    {
        if(cancel){
            GameObject.FindGameObjectWithTag("automationManager").GetComponent<AutomationManager>().ListAddDeviceEff.SetActive(false);
        ...
        GameObject effect = AutomationManagerBottom.AutomationPanels[AutomationManagerBottom.currentActiveIndex].gameObject.transform.Find("MenuContentLeftMargin/HorizontalPageScroll/AddEffect").gameObject;//  GameObject.FindGameObjectWithTag("addEffect");
        // effect.GetComponent<AddEffectSelection>().AddOptions(objectType);
        AutomationManager.aktTypEff = objectType;
        GameObject.FindGameObjectWithTag("automationManager").GetComponent<AutomationManager>().ListAddDeviceEff.SetActive(false);
        GameObject.FindGameObjectWithTag("automationManager").GetComponent<AutomationManager>().LibraryPage.SetActive(true);
        GameObject.FindGameObjectWithTag("automationManager").GetComponent<AutomationManager>().AddDeviceEffFunc(gameObject, name, Prefab, Reihen);
        Reihen = null;
        DeleteSelection();
        return null;
    }
